...
public class SistemaGestion {
    // Composición: el sistema gestiona estas listas
    ...
    // Método para demostrar el polimorfismo
    public void mostrarInformacionDeTodos() {
        ...
        for (Estudiante e : estudiantes) {
            e.mostrarInformacion(); // Llamada polimórfica
        }
        for (Profesor p : profesores) {
            p.mostrarInformacion(); // Llamada polimórfica
        }
    }
}